...
export const ListAssignationFragmentDoc = gql`
  ...
  statusmessage
    ...
    ${ListAgentFragmentDoc}`;
export const ListCollectionFragmentDoc = gql`
    fragment ListCollection on Collection {
  __typename
  id
  name
  description
...
export const NodesDocument = gql`
    query Nodes($search: String, $interfaces: [String], $collections: [ID], $restrict: [String], $templated: Boolean, $scopes: [NodeScope]) {
  allnodes(
    search: $search
