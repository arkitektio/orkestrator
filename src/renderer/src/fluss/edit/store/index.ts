import { FlowFragment, GlobalArgFragment } from "@/fluss/api/graphql";
import {
...
import { integrate, istriviallyIntegratable } from "@/fluss/validation/integrate";
import { FlowState, ValidationResult } from "@/fluss/validation/types";
import { validateState } from "@/fluss/validation/validate";
import { edges_to_flowedges, handleToStream, nodes_to_flownodes } from "@/fluss/utils";
import {
  Connection,
  Edge,
  EdgeChange,
