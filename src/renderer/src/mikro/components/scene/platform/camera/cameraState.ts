...
import { AxisType } from "@/mikro/api/graphql";
import type { CameraStateFragment } from "@/mikro/api/graphql";
 ...
 * (`@/mikro/lib/coords/transformGraph.ts` `evalTransform`) already assumes a spatial axis
