...
export const ELEKTRO_PAGINATED_FIELDS: PaginatedFieldMap = {
  analogSignalChannels: ["filters", "ordering"],
  analogSignals: ["filters", "ordering"],
  blocks: ["filters", "ordering"],
  ...
  mydatasets: ["filters", "ordering"],
  myfiles: ["filters", "ordering"],
  neuronModels: ["filters", "ordering"],
  recordings: ["filters", "ordering"],
  rois: ["filters", "ordering"],
  simulations: ["filters", "ordering"],
  stimuli: ["filters", "ordering"],
  traces: ["filters", "ordering"],
