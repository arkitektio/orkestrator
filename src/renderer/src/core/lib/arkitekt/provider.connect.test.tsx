...
import { claimProfileMesh, joinAndPark } from "@/core/lib/mesh/profileMesh";
...
vi.mock("@/core/lib/mesh/profileMesh", async (importOriginal) => ({
  ...(await importOriginal<typeof import("@/core/lib/mesh/profileMesh")>()),
