 ...
 *
 * Extracted rather than left inline in the provider for the same reason
 * `CredentialRotation` (lib/zarr/store/credentialRotation.ts) was extracted:
 * the forced-vs-raced rule is the subtle part, it is invisible in normal
 * operation, and it is worth pinning with tests of its own.
 */
