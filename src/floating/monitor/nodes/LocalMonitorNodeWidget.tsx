...
export const LocalMonitorNodeWidget: React.FC<ArkitektNodeProps> = withLayout(
  ({ data, id }) => {
    ...
    return (
      <NodeMonitorLayout id={id}>
        ...
        <div className="flex-initial font-light text-xl mb-1 custom-drag-handle cursor-pointer truncate ">
          {node_data?.node?.name}{" "}
